...
## Architecture
- Owns draft keybinding state, parsing, field-level labels/config read/write, grouping, recorder normalization, conflict lookup, the bulk `ShortcutManagerSummary`, and tests.
