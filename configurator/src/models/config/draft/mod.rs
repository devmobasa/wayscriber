...
pub struct ConfigDraft {
    ...
    pub drawing_marker_snap_to_text: bool,
    ...
    pub ui_show_status_color: bool,
    pub ui_show_status_tool: bool,
    pub ui_show_status_size: bool,
    pub ui_show_status_context_indicators: bool,
    pub ui_show_toolbar_hint: bool,
    pub ui_show_status_help: bool,
    pub ui_show_status_about: bool,
    ...
    pub ui_show_shape_size_readout: bool,
