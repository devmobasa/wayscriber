...
impl ConfigDraft {
    pub fn from_config(config: &Config) -> Self {
        ...
        Self {
            ...
            drawing_marker_snap_to_text: config.drawing.marker_snap_to_text,
            ...
            ui_show_status_color: config.ui.show_status_color,
            ui_show_status_tool: config.ui.show_status_tool,
            ui_show_status_size: config.ui.show_status_size,
            ui_show_status_context_indicators: config.ui.show_status_context_indicators,
            ui_show_toolbar_hint: config.ui.show_toolbar_hint,
            ui_show_status_help: config.ui.show_status_help,
            ui_show_status_about: config.ui.show_status_about,
