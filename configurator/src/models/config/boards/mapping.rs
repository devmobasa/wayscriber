...
impl OptionalTripletInput {
    pub(super) fn from_option(value: Option<&BoardColorConfig>, fallback: [f64; 3]) -> Self {
        match value {
            Some(color) => Self {
                enabled: true,
...
impl BoardItemDraft {
    pub(super) fn from_config(item: &BoardItemConfig) -> Self {
