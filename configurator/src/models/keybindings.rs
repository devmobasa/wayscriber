...
impl KeybindingField {
    ...
    fn get<'a>(&self, config: &'a KeybindingsConfig) -> &'a Vec<String> {
        match self {
            ...
            Self::ToggleClickthrough => &config.toggle_clickthrough,
            Self::HoldToDraw => &config.hold_to_draw,
    ...
    fn set(&self, config: &mut KeybindingsConfig, value: Vec<String>) {
        match self {
            ...
            Self::ToggleClickthrough => config.toggle_clickthrough = value,
            Self::HoldToDraw => config.hold_to_draw = value,
