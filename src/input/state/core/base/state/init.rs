...
impl InputState {
    ...
    pub fn with_defaults(
        ...
        let mut state = Self {
            ...
            eraser_mode,
            marker_opacity,
            marker_snap_state: crate::input::state::MarkerSnapState::Off,
            marker_text_snap: crate::input::text_snap::TextSnapMap::default(),
            pending_marker_snap_scan: false,
            active_marker_snap_row: None,
            last_marker_snap_preview_bounds: None,
