...
impl InputState {
    ...
    pub fn with_defaults(
        ...
        let mut state = Self {
            ...
            toolbar_session_popover_open: false,
            toolbar_settings_popover_open: false,
            toolbar_canvas_popover_open: false,
            ...
            toolbar_side_layout: crate::config::ToolbarSideLayout::Panel,
            ...
            pending_copy_hex: None,
            pending_paste_hex: None,
