...
impl InputState {
    ...
    pub fn switch_board(&mut self, target_id: &str) {
        with_legacy_measurer(|measurer| self.switch_board_with_measurer(measurer, target_id))
    }
    ...
    pub fn switch_board_force(&mut self, target_id: &str) {
        with_legacy_measurer(|measurer| self.switch_board_force_with_measurer(measurer, target_id))
    }
    ...
    pub fn create_board(&mut self) -> bool {
        with_legacy_measurer(|measurer| self.create_board_with_measurer(measurer))
    }
    ...
    pub fn switch_board_slot(&mut self, slot: usize) {
        with_legacy_measurer(|measurer| self.switch_board_slot_with_measurer(measurer, slot))
    }
    ...
    pub fn switch_board_next(&mut self) {
        with_legacy_measurer(|measurer| self.switch_board_next_with_measurer(measurer))
    }
    ...
    pub fn switch_board_prev(&mut self) {
        with_legacy_measurer(|measurer| self.switch_board_prev_with_measurer(measurer))
    }
    ...
    pub fn duplicate_board(&mut self) {
        with_legacy_measurer(|measurer| self.duplicate_board_with_measurer(measurer))
    }
    ...
    pub fn switch_board_recent(&mut self) {
        with_legacy_measurer(|measurer| self.switch_board_recent_with_measurer(measurer))
    }
