use super::{
    ToolbarLayoutSpec, create_test_input_state, rendered_side_hits, side_size, snapshot_from_state,
};
use crate::backend::wayland::toolbar::events::HitKind;
use crate::backend::wayland::toolbar::hit::HitRegion;
use crate::input::Tool;
use crate::ui::toolbar::{
    SessionRecentSnapshot, SidePane, ToolbarEvent, ToolbarSideSection, ToolbarSnapshot,
};
...
fn populate_session(snapshot: &mut ToolbarSnapshot) {
...
#[test]
fn draw_pane_sections_collapsed_keep_only_headers() {
    let mut state = create_test_input_state();
    state.toolbar_side_pane = SidePane::Draw;
...
#[test]
fn canvas_pane_sections_collapsed_keep_only_headers() {
    let mut state = create_test_input_state();
