...
#[allow(unused_imports)]
pub use render::{
    BlurRectParams, BoardPaper, EraserReplayContext, IMMUTABLE_RASTER_SOURCE_TOKEN, RenderCaches,
    RenderCtx, SpotlightMagnifierMetrics, SpotlightMagnifierOutcome, SpotlightMagnifierScratch,
    SpotlightMagnifierSource, SpotlightPass, SpotlightRegion, SpotlightSnapshotStrategy,
    board_paper_device_scale, caret_line_width, caret_outline_width, painted_background_luminance,
    perceived_luminance, render_blur_rect, render_board_background, render_click_highlight,
    render_freehand_borrowed, render_marker_stroke_borrowed, render_selection_halo,
    render_selection_halo_with_measurer, render_selection_handles, render_shape, render_shape_over,
    render_shape_over_with_halo, render_shape_with_halo, render_spotlight_magnification_pass,
    render_spotlight_pass, render_sticky_note, render_sticky_note_with_measurer, render_text,
    render_text_over_with_halo, render_text_over_with_halo_with_measurer, render_text_with_halo,
...
pub(crate) use render::{LaserStyle, render_laser_stroke};
#[allow(unused_imports)]
pub use shape::{
