...
impl BoardsConfig {
    ...
    pub fn default_overlay_item() -> BoardItemConfig {
        BoardItemConfig {
    ...
    pub fn from_legacy(legacy: &BoardConfig) -> Self {
        let mut items = vec![BoardsConfig::default_overlay_item()];
...
pub struct BoardItemConfig {
    ...
    /// Non-selectable paper decoration on a solid background.
    #[serde(default)]
    pub grid: super::BoardGridConfig,
