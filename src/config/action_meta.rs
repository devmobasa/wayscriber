    ...
    fn assert_actions_have_flag(
        ...
        for action in actions {
            ...
            let meta = action_meta(*action)
                .unwrap_or_else(|| panic!("missing ActionMeta for {:?}", action));
